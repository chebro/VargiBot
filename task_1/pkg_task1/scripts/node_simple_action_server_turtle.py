...
class SimpleActionServerTurtle:
    """
    Simple Action Server Class : /action_turtle, /turtle1/cmd_vel, /turtle1/pose
    """
    def __init__(self):
...
def main():
    ...
    # Subscribe to Pose of the Turtle
    rospy.Subscriber(obj_server._config_ros_sub_topic,
                     Pose,
                     obj_server.func_ros_sub_callback)
